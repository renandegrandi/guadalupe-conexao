...
namespace Guadalupe.Conexao.App.Components
{
    public partial class ButtonWithSpinner: Xamarin.Forms.Grid
    {
        ...
        //    propertyChanged: (bindable, oldVal, newVal) => ((ButtonWithSpinner)bindable).OnIsEnabledChange((bool)newVal));
        ...
        private void OnIsEnabledChange(bool value) 
        {
            InnerButton.IsEnabled = value;
        }
