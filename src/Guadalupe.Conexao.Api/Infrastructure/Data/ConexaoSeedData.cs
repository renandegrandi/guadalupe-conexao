        ...
        public static void Initialize(IServiceProvider service)
        {
            ...
            using (var scope = service.CreateScope())
            {
                using (var context = scope.ServiceProvider.GetRequiredService<ConexaoContext>())
                {
                    ...
                    "Disse - lhe Jesus: Deixai vir a mim estas criancinhas e não as impeçais, porque o Reino dos Céus é para aqueles que se lhes assemelham” (Mt 19, 14).", $"Images/Notice/{noticeFive}.jpg")
                        .AddPostedBy(missaoPerson)
