        ...
        public static void Initialize(IServiceProvider service) 
        {
            using (var scope = service.CreateScope()) 
            {
                ...
                if (@new) 
                {
                    ...
                    var missaoUser = new Domain.User(missao);

                    var notices = new List<Domain.Notice>();

                    notices.Add(new Domain.Notice("O bom samaritano", "O Bom Samaritano \nHomenagem aos 90 anos do nosso amado Padre Carlos", "Imagens/imagem21.jpg")
                        .AddPostedBy(missao)
                        .ModifyRegistrationDate(new DateTime(2020, 11, 27)));
                    notices.Add(new Domain.Notice("Grupo de oração","Mais uma semana abençoada está começando e hoje é dia de Grupo de Oração.\n" +
                    ...
                    notices.Add(new Domain.Notice("Terço de Misericórdia", "Terço da Misericórdia", "Imagens/imagem18.jpg")
                        .AddPostedBy(missao)
                        .ModifyRegistrationDate(new DateTime(2020, 11, 28)));
                    notices.Add(new Domain.Notice("É pizza!!","Quando pessoas com o coração cheio de amor se reúnem para fazer o bem, só pode acabar em... EM PIZZA!!!!!\n" +
                    ...
                    notices.Add(new Domain.Notice("Nossa Senhorinha de guadalupe","O processo seletivo para a escolha da Nossa Senhorinha de Guadalupe e do Juan Dieguito vai começar!\n" +
